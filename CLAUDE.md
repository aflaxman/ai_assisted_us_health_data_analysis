...
4. **Outputs in `outputs/`** — inside the project subdirectory; figures appear inline in notebooks (no separate PNG files); do **not** write CSV files to `outputs/` unless explicitly requested
